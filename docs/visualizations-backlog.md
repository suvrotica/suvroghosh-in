...
| Exhibit                                | Scientific concept                                                              | Proposed interaction                                                                   | Rendering approach                                          |
| -------------------------------------- | ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| Evolving Microbe Garden — shipped      | Selection pressure, inheritance, mutation, drift, energy, and carrying capacity | Change resources, mutation, costs, predators, and founder size; replay identical seeds | Canvas 2D agents with SVG histories and trait distributions |
