...
const port = Number(process.env.PLAYWRIGHT_PORT ?? 4221);
const baseURL = `http://127.0.0.1:${port}`;
const articleURL = `${baseURL}/blog/visualizations/gradient-descent-landscapes`;

export default defineConfig({
	testDir: './tests/browser',
	testMatch: 'gradient-descent.spec.ts',
	fullyParallel: false,
	workers: 1,
	timeout: 120_000,
	expect: {
