...
const port = Number(process.env.PLAYWRIGHT_PORT ?? 4233);
const baseURL = `http://127.0.0.1:${port}`;
const articleURL = `${baseURL}/blog/visualizations/the-museum-of-invisible-weather`;

export default defineConfig({
	testDir: './tests/browser',
	testMatch: 'invisible-weather.spec.ts',
	fullyParallel: false,
	workers: 1,
	timeout: 120_000,
