...
const articleURL = `${baseURL}/blog/visualizations/static-equilibrium-illusion`;

export default defineConfig({
	testDir: './tests/browser',
	testMatch: 'static-equilibrium-illusion.spec.ts',
	fullyParallel: false,
	workers: 1,
	timeout: 180_000,
	expect: { timeout: 30_000 },
	reporter: [['list']],
	outputDir: 'test-results/static-equilibrium-illusion',
	use: {
		baseURL,
