...
{#if newer || older}
	<nav
		...
		class="post-navigation mt-12 border-y border-neutral-200 py-6 dark:border-neutral-800"
	>
		<div class="post-navigation__grid grid grid-cols-1 gap-4 sm:grid-cols-2">
			{#if newer}
				<a
					...
					class="post-navigation__item post-navigation__item--newer group flex min-h-28 flex-col rounded-lg border border-neutral-200 bg-white p-4 no-underline shadow-sm transition-colors hover:border-neutral-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-600 dark:border-neutral-800 dark:bg-neutral-900/50 dark:hover:border-neutral-600 dark:focus-visible:outline-neutral-300"
				>
					<span
						class="post-navigation__eyebrow text-xs font-bold tracking-[0.12em] text-neutral-500 uppercase dark:text-neutral-400"
					>
						<span aria-hidden="true">&larr;</span> Newer post
					</span>
					<span
						class="post-navigation__title mt-2 leading-snug font-semibold text-neutral-900 group-hover:text-neutral-600 dark:text-neutral-100 dark:group-hover:text-neutral-300"
					>
						{newer.title}
					</span>
					<span
						class="post-navigation__meta mt-auto pt-3 text-xs text-neutral-500 dark:text-neutral-400"
					>
