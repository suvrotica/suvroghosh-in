<script lang="ts">
	...
	const socialLinks = [
		{
			href: 'https://github.com/suvrotica',
			label: 'GitHub',
	...
	<ScrollReveal class="max-w-4xl mx-auto">
		<div class="flex flex-col sm:flex-row items-center justify-between gap-4">
			<p class="text-sm text-neutral-600 dark:text-neutral-400 text-center sm:text-left">
				...
				<a
					href={`mailto:${email}`}
					class="underline underline-offset-4 hover:text-gold transition-colors"
				>
					{email}
				</a>
			</p>
			...
			<div class="flex items-center gap-3">
				{#each socialLinks as link}
					<a
						...
						class="text-neutral-500 dark:text-neutral-400 hover:text-gold transition-colors"
