...
<aside class="controls" aria-labelledby="ct-controls-heading">
	<header class="control-header">
		<div>
			<p>Acquisition console</p>
			<h3 id="ct-controls-heading">Scan controls</h3>
		</div>
		...
		<div class="field-grid">
			...
			<label class="select-field" for="ct-detectors">
				...
				<select
					...
					onchange={(event) => onacquisitionchange('detectorCount', Math.round(numberValue(event)))}
				>
	...
	<details>
		...
		<div class="field-grid">
			...
			>
				{fullscreen ? 'Exit fullscreen laboratory' : 'Open laboratory fullscreen'}
			</button>
		</div>
	</details>

	<p class="boundary">
		Dose is a relative educational proxy. Material attenuation and spectral values are illustrative,
		not calibrated Hounsfield units or scanner protocol values.
	</p>
</aside>
