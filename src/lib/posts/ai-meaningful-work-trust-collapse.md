...
That is what the new AI feels like. Not the tool itself—the tool is only electricity—but the doubt that follows it. The suspicion that seeps into every polished thing that arrives on a screen.

Job loss is frightening enough, yes. A salary is not poetry. It buys rice, medicine, rent, school fees, phone recharge, blood pressure tablets, and that occasional reckless packet of mutton biryani after which one repents like a minor saint. But the deeper injury is stranger.
...
Let us be fair to history. The old internet was not innocent. There was spam, plagiarism, fake gurus, copied recipes, keyword-stuffed rubbish, and comment sections that made one reconsider democracy before breakfast. Human beings produced garbage long before machines learned to assist. The rubbish heap has ancestors.
...
Can this thing be believed? Does it help anyone? Does it carry responsibility? Is there a human mind behind it, or only a machine arranging yesterday’s furniture in today’s room?
...
A human being needs time. Not because humans are noble by default—we are lazy, vain, distracted, frightened, and often powered by tea and resentment—but because real work usually requires friction. You try a thought. It breaks. You try another. It smells false. You cut a paragraph. You find a better one. You notice that your first opinion was a street dog wearing a crown. You remove the crown. The dog remains, but at least now you know what you are dealing with.
...
A poem is not valuable only because it contains words in lines. A song is not valuable only because melody meets rhythm. An essay is not valuable only because it explains an idea. These things carry contact. Somewhere inside them is the trace of a person who was alive in a particular body, with particular fears, jokes, debts, habits, memories, and weather.

AI can imitate the trace. It can write about loneliness without being lonely. It can write about Calcutta without having inhaled dust, rain, frying oil, and bus smoke in one democratic lungful. It can write about middle age without waking at four in the morning and feeling the future shrink like a wet shirt. It can write about poverty without bargaining for a repair, postponing a dentist, or calculating whether one more month can be stretched like old elastic. It can write about grief without having one ordinary cup in the kitchen become unbearable because the person who used it is gone.
...
The question cannot simply be, "Was AI used?" That is already too crude. A writer may use AI to clean a sentence and still own the piece. A musician may use AI for a texture and still carry the song. A student may use AI to understand a topic and still do the thinking. A worker may use AI because the boss wants ten documents by Friday and the boss’s boss wants a dashboard proving the documents are transformative.

On the other hand, a person may generate the whole thing, change three adjectives, and walk away whistling.

So the better question is: who stands behind the final meaning? Who checked it? Who understands it? Who will correct it? Who knows what is missing? Who is responsible when the polished answer turns out to be nonsense wearing perfume?
...
AI has made furniture cheap. Now we must decide what deserves a room.

For working people, the fear is immediate, and the numbers are beginning to catch up with the feeling. In early 2026, a survey of fourteen thousand workers across nineteen countries found that while regular AI use jumped thirteen percent, confidence in the technology plummeted by nearly twice that. Workers are being handed tools without training, context, or support, and the gap between adoption and understanding is where the anxiety lives.
...
Do not outsource the wound. Do not outsource taste. Do not outsource the sentence where you finally say what you actually mean.
...
A fluent lie is still a lie. A fluent imitation is still an imitation. A fluent empty thing is still empty, though it may have excellent punctuation.
...
AI can make a thousand lamps. But someone must still know where the light is needed.
