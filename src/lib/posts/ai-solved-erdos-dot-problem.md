...
Erdős suspected that the number of exact unit-distance pairs could not grow too much faster than the number of dots. In loose language, if the number of dots was $n$, the number of special pairs was expected to be only a little more than $n$ in the long run. Not wildly more. Not a festival crowd. More like a disciplined queue, which in our part of the world is already a fantasy novel.
