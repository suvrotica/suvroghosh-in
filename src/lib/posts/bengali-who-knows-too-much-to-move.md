...
One can make an equation of this, because the Bengali mind cannot resist turning even its underwear drawer into a framework. Let $B$ be the Bengali Self-Sabotage Index.

$$B = {T \times A \over W}$$

Here $T$ is thought, $A$ is avoidance, and $W$ is work actually completed.

When $T$ and $A$ rise while $W$ approaches zero, $B$ becomes enormous. Past a certain limit, the man undergoes a phase change. He is no longer solid, liquid, or gas. He becomes adda.
