...
In the nineteenth century, Rudolf Clausius gave entropy its name. Then Ludwig Boltzmann came along and made the thing more frightening by putting probability underneath it. His famous formula, $S=k\log W$, is carved on his grave, which is either magnificent or the darkest joke in Austrian stonework. The letter $W$ means the number of microscopic arrangements that still produce the same broad appearance.
