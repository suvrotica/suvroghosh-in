...
description: "A clear look at Tau Scaling Law and the semiconductor bet on shortening processing time instead of only shrinking transistors."
date: "2026-06-01"
dateModified: "2026-08-07"
category: "Technology"
tags: ["Tau Scaling","Moore Law","Time Leaks","Real Job","Huawei","Tau","Chip","Chips","Moore","Scaling"]
published: true
color: "slate"
thumbnail: "/thumbnail/art-tau-scaling-law-time-not-nanometers.jpg"
thumbnailAlt: "Identical chip tiles moving through compressed stages on an unmarked timing ring"
---

<TTS />

<Pi src="/thumbnail/art-tau-scaling-law-time-not-nanometers.jpg" />

Acronyms and terms used in this post:

Tau or $τ$: A Greek letter often used in engineering to represent time-related behavior, especially delay or time constant.
...
Tau, written as $τ$, is not a decorative Greek moustache pasted on a marketing slide. In electronics, tau already has the smell of delay. In a simple RC circuit, $τ=RC$ tells you how quickly voltage rises or falls. In ordinary English, it asks: how long does the electrical thing take to become useful?
