...
pinnedTags: ["Bodyshopping Moat","Linear Algebra","Adversarial Attacks","AI-driven Healthcare","Model Drift","Healthcare","AI","Systems","Genetic","Clinical"]
published: true
color: "#2E5C8A"
thumbnail: "/thumbnail/social-human-margin.jpg"
thumbnailAlt: "A human hand pauses a clinical data card at the edge of an opaque healthcare system."
rawThoughtLayout: "healthcare-human-margin"
...
<ThoughtSpread id="uncomfortable-premise">

<ThoughtLeaf side="left" label="The premise">
...
<ThoughtLeaf side="right" label="The gap">
...
<ThoughtSpread id="who-builders-frontline">

<ThoughtLeaf side="left" label="Builders">
...
<ThoughtLeaf side="right" label="Frontline witnesses">
...
<ThoughtSpread id="who-power-exposure">

<ThoughtLeaf side="left" label="Power / exposure">
...
<ThoughtSpread id="what-map-territory">

<ThoughtLeaf side="left" label="Map / territory">
...
<ThoughtSpread id="when-usable-ai">

<ThoughtLeaf side="left" label="The inflection">
...
<HumanMarginModule type="timeline" />
...
<ThoughtLeaf side="right" label="Newness / consequence">

<ThoughtArt id="ai-convergence" />
...
<ThoughtSpread id="where-systems-touch-bodies">

<ThoughtLeaf side="left" label="Care / research">
...
<ThoughtArt id="rural-image-transfer" />
...
<ThoughtSpread id="why-stakes-incentives">

<ThoughtLeaf side="left" label="Stakes / incentives">
...
<ThoughtSpread id="why-corruption-attack-surface">

<ThoughtLeaf side="left" label="Corruption">
...
<HumanMarginModule type="corruption" />

</ThoughtLeaf>

<ThoughtLeaf side="right" label="Attack surface">
...
<HumanMarginModule type="threats" />

<ThoughtArt id="adversarial-clinical-film" />

</ThoughtLeaf>

</ThoughtSpread>

<ThoughtSpread id="how-writers-method">

<ThoughtLeaf side="left" label="Mechanics / method">
...
<ThoughtLeaf side="right" label="Skepticism / narrative">

<ThoughtArt id="method-tea-notebook" />
...
<ThoughtSpread id="technology-stack">

<ThoughtLeaf side="left" label="Stack / I">
...
<ThoughtSpread id="bigger-unfinished-systems">

<ThoughtLeaf side="left" label="Not there yet">
...
<ThoughtLeaf side="right" label="Better questions">
...
<ThoughtSpread id="bigger-judgment-invitation">

<ThoughtLeaf side="left" label="Judgment">
...
<ThoughtLeaf side="right" label="Corrections / sources">
